...
def main():
 ...
 fig.suptitle(f'Expanded-space transfer: {N} held-out families × 96 fresh candidates\n10 optimizer seeds; pointwise 95% family-bootstrap intervals',fontsize=13)
