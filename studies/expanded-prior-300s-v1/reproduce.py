...
DATA = ROOT / 'data/heldout-expanded-v1'
...
def main():
    ...
    parser.add_argument('--output', type=Path, default=ROOT / 'runs/reproduction-300s')
    ...
    environment.update(fit_cpu_cap=300, runner_sha256=hashlib.sha256(Path(__file__).read_bytes()).hexdigest())
