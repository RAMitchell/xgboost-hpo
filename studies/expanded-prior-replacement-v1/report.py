...
def main():
 ...
 fig.suptitle(f'300-second limit, Dilbert replaced: {N} held-out families × 96 fresh candidates\n10 optimizer seeds; pointwise 95% family-bootstrap intervals',fontsize=13)
